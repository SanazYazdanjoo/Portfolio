 ...
 "projects": [
  {
   ...
   "wireframe": "Before the high-fidelity screens were built, the layouts were drawn as wireframes against the numbered requirements from Phase 2. A wireframe fixes the structure of a screen — which elements it contains, in what order, and which rules apply — before colour and typography come in. The low-fidelity set was built as a clickable prototype in Figma Make, one tab per view, so the navigation between the screens could be walked through and not just imagined. The strip below shows the path for the attendance-month screen: the paper sketch from the process observation, the wireframe, and the screen as it shipped; the wireframe itself follows at full size.",
