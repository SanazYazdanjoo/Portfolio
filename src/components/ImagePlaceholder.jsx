...
export const ImagePlaceholder = ({ text = "Coming Soon" }) => {
  return (
    ...
    <div className="absolute inset-0 w-full h-full [--rule-fill-color:rgb(var(--muted-rgb)/0.2)] flex flex-col items-center justify-center overflow-hidden border rule-frame-in relative group">
