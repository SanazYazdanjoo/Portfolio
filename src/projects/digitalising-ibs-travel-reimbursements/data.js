...
export const projectData = {
  ...
  metrics: [
    ...
    { value: 'n=2', label: { en: 'expert interviews — project management, accounting — plus one working meeting with the administration team, checking the failure set from the administrative and the financial side', de: 'Experteninterviews — Projektleitung, Buchhaltung — plus ein Arbeitstreffen mit dem Verwaltungsteam, Prüfung der Fehlermenge aus administrativer und finanzieller Sicht' } },
