...
export const projectData = {
  ...
  metrics: [
    ...
    { value: { en: '>1 yr', de: '>1 Jahr' }, label: { en: 'administering the process as project assistant before redesigning it — insider observation as the first evidence source', de: 'den Prozess als Projektassistentin administriert, bevor ich ihn neu entwarf — Insider-Beobachtung als erste Evidenzquelle' } },
  ...
  limitations: [
    {
      en: 'I administered this process for more than a year — as the project assistant, not as a claimant — so the problem framing starts from my own experience of operating it. The survey was designed to make those assumptions falsifiable — and reversed one of my priorities — but no independent researcher has reviewed the problem register.',
      de: 'Ich habe diesen Prozess über ein Jahr als Projektassistentin administriert — nicht als Antragstellerin —, die Problemrahmung beginnt also bei meiner eigenen Erfahrung im Betrieb. Die Umfrage war darauf angelegt, diese Annahmen falsifizierbar zu machen — und kehrte eine meiner Prioritäten um —, doch kein:e unabhängige:r Forschende:r hat das Problemregister geprüft.',
    },
    {
  ...
  tagEvidence: [
    { tag: 'UX Research', evidence: "methods: insider observation (>1 year administering the process as project assistant), two expert interviews plus an administration-team meeting, participant survey (n=6 and open); metrics records six of the 25 documented problems as survey-contributed; verbatims quotes three respondents", status: 'evidenced' },
    ...
    { tag: 'Excel Automation (ExcelJS)', evidence: "techStack: ExcelJS / local Excel files — the adapters that read the institute's existing workbooks so nothing has to be migrated by hand, and generate the filled Abrechnung form from stored data", status: 'evidenced' },
