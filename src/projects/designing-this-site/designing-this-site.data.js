...
export const projectData = {
  ...
  figures: {
    wireframe: [
      ...
      },
      {
        ...
        title: {
          en: 'One column, a section index, no rails',
          de: 'Eine Spalte, ein Abschnittsverzeichnis, keine Randspalten',
        },
        description: {
          en: 'The same template below md: the TOC becomes an in-flow section index, sections stack in the same order, the pull-quote doesn’t render. One responsive layout, not a separate mobile design — but a deliberately plainer one: nothing on the phone page is pinned or moves with the scroll.',
          de: 'Dieselbe Vorlage unterhalb von md: Die Abschnittsleiste wird zu einem mitscrollenden Abschnittsverzeichnis, die Abschnitte stapeln sich in derselben Reihenfolge, die Pull-Quote rendert nicht. Ein responsives Layout, kein separates Mobildesign — aber ein bewusst schlichteres: Nichts auf der Telefonseite ist fixiert oder bewegt sich mit dem Scrollen.',
        },
        alt: {
  ...
  tagEvidence: [
    ...
    { tag: "Responsive Design", evidence: "wireframe: three tracks above the xl breakpoint, one column with an in-flow section index below it; figures.wireframe shows both states of the same layout", status: "evidenced" },
