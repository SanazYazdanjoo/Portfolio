...
// Wireframes → Design System → Prototype → Metrics. The `sectionTitles`
...
export const projectData = {
  ...
  // would contradict it. The chip returns when the sessions do. With no
  // methodology prose on this project, the template renders this list (and
  // the tech stack) under Prototype instead.
  methods: [
  ...
  metricsIntro: {
    en: "Lighthouse 13.4.0 against production, emulated desktop, 24 August 2026. The pending rows are protocols that are defined but not yet run — a number appears here when it exists, not before.",
    de: "Lighthouse 13.4.0 gegen die Produktionsseite, emulierter Desktop, 24. August 2026. Die ausstehenden Zeilen sind definierte, aber noch nicht gelaufene Protokolle — eine Zahl erscheint hier, wenn sie existiert, nicht vorher.",
  },
