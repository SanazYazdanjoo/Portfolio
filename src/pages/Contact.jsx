      ...
      <div className="container relative z-10 mx-auto max-w-4xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-10">
            <div>
              <h3 className="text-sm font-black uppercase tracking-widest text-primary mb-4">{t("contact.email")}</h3>
              <a 
            ...
            <div>
              <h3 className="text-sm font-black uppercase tracking-widest text-primary mb-4">{t("contact.locationPhone")}</h3>
            ...
            <div>
              <h3 className="text-sm font-black uppercase tracking-widest text-primary mb-4">{t("contact.socials")}</h3>
          ...
          <div className="bg-panel p-8 border border-border rounded-sm shadow-sm relative rotate-1">
            ...
            <h3 className="text-xl font-bold text-text mb-6">{t("contact.collaborate")}</h3>
